...
public class HashTable<E> {
  ...
  public boolean search(E data) {
    ...
    if (this.array[index] != null && this.array[index].equals(data)) return true;
    else if (this.array[index] != null && array[rehash(data)].equals(data)) return true;
    else {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Size after inserting 3 elements: " + hashTable.getSize()); // Should print: 4
    ...
    System.out.println(
        "Search for 'data1' after removal: " + (hashTable.search("data1"))); // Should print: false
    ...
    System.out.println(
        "Size after inserting 7 more elements: " + hashTable.getSize()); // Should print: 10
    System.out.println(
        "Capacity after inserting 7 more elements: " + hashTable.getCapacity()); // Should print: 17
    // (If Resized)
  }
}
